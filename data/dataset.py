...
class TrainDateset(Dataset):
    ...
    def __init__(self, path, transform=None, args=None):
        ...
        if args is not None:
            with open(os.path.join(args.output_dir,'gshape2class.json'),'w') as f:
                json.dump(self.gshape2class, f)
    ...
    def __getitem__(self, index):
        ...
        label = np.array([info_dict["label_class"],
                          info_dict["label_shape"],
#                           info_dict["label_angle"],
                          info_dict["z"],
                          info_dict["label_gshape"],
...
class TestDateset(Dataset):
    ...
    def __init__(self, path, transform=None, args=None):
        ...
        if args is not None:
            ...
            self.gshape2class = gshape2class
